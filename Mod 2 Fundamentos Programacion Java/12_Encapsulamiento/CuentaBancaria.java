class CuentaBancaria {
    ...
    // set es void y no tiene return porque no devuelve nada, solo asigna un valor al atributo
    public void setTitular(String t) {
        titular = t;
    }
    // mientras que: get devuelve el valor del atributo, por eso tiene un return y no es void.
